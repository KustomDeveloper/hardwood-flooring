            ...
            <div class="topbar">
                <div class="top-inner">
                    ...
                    <p class="company-email">
                        <img src="<?php bloginfo("stylesheet_directory"); ?>/img/envelope-icon.png" /> info@hardwoodflooringproselpasotx.com</p>
                    <p class="top-phone">
                    ...
                    <p class="top-social">
                        <img class="top-fb" src="<?php bloginfo("stylesheet_directory"); ?>/img/top-fb.png" />
                        <img class="top-tw" src="<?php bloginfo("stylesheet_directory"); ?>/img/top-tw.png" />
                        <img class="top-yt" src="<?php bloginfo("stylesheet_directory"); ?>/img/top-yt.png" />
                        <img class="top-li" src="<?php bloginfo("stylesheet_directory"); ?>/img/top-li.png" />
                        <img class="top-pi" src="<?php bloginfo("stylesheet_directory"); ?>/img/top-pi.png" />
                    </p>
                </div>
            </div>
